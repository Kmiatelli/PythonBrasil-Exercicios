...
**2** - _Faça um programa que leia um nome de usuário e a sua senha e não aceite a senha igual ao nome do usuário, mostrando uma mensagem de erro e voltando a pedir as informações._

**3** - _Faça um programa que leia e valide as seguintes informações:_
...
**6** - _Faça um programa que imprima na tela os números de 1 a 20, um abaixo do outro._
